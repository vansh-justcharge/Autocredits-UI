...
const Inspection = () => {
    ...
    const handleChange=(e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>)=>{
        setInspectionForm({
            ...inspectionForm,[e.target.name]:e.target.value
        })
    }
  ...
  return (
    <div>
      <div className='w-full p-6'>
        <h1 className='text-2xl font-semibold'>Insepection</h1>
        <form className='p-6'>
            <div className='flex w-full mb-12'>
                ...
                <div className='w-full ml-6 '>
                    ...
                    value={inspectionForm.inspectionReferenceNo}
                    onChange={handleChange}
                ...
                <div className='w-full '>
                    ...
                    type='text'
                    placeholder='Comment'
                    value={inspectionForm.inseptionComment}
                    onChange={handleChange}
                    className='px-3 py-2 text-gray-700  bg-gray-100 border border-gray-200  w-full rounded'
                    ></input>
                </div>
                <button className='mt-16 w-full bg-black text-white px-6 py-2 text-[16px] rounded'>
                    Save and Submit
                </button>
        </form>
      </div>
