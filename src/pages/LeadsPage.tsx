...
const DEMO_LEADS = [
  {
    ...
    additionalDetails: "Interested in quick approval",
  ...
  },
  {
    ...
    additionalDetails: "Looking for used SUV",
  ...
  },
  {
    ...
    additionalDetails: "Has a 2018 Honda City",
  ...
  },
  {
    ...
    additionalDetails: "Loan not approved",
  ...
  },
  {
    ...
    additionalDetails: "Bought insurance for new car",
  ...
  },
  {
    ...
    additionalDetails: "Wants to sell quickly",
  ...
  },
  {
    ...
    additionalDetails: "Proposal sent",
  ...
  },
  {
    ...
    additionalDetails: "Eligible for premium plan",
  ...
  },
  {
    ...
    additionalDetails: "Negotiating price for Honda Amaze",
    createdAt: "2024-06-20T15:10:00Z",
    notes: []
  }
]

type Lead = typeof DEMO_LEADS[number]
...
const LeadsPage: React.FC = () => {
  ...
  const handleDeleteLead = (id: string | null) => {
    if (!id) return
    setLeads(leads.filter((lead) => lead._id !== id))
    setDeletePopup({ show: false, id: null })
  }
